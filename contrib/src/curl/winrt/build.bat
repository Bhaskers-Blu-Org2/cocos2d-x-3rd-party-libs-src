...
set CMAKE_ARGS=-DCURL_ZLIB:BOOL="1" -DCMAKE_USE_OPENSSL:BOOL="1" -DCMAKE_USE_LIBSSH2:BOOL="0" -DENABLE_UNIX_SOCKETS:BOOL="0" -DENABLE_MANUAL:BOOL="0" -DBUILD_CURL_EXE:BOOL="0" -DBUILD_TESTING:BOOL="0" -DUSE_WIN32_LDAP:BOOL="0" -DCURL_DISABLE_TELNET:BOOL="1" -DENABLE_IPV6:BOOL="0"
